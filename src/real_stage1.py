...
np.save("../data/action_"+string,act_tab)
np.save("../data/non_pessi_"+string,generate_tab(arm_non_pessi))
np.save("../data/pessi_"+string,generate_tab(arm_pessi))
np.save("../data/quantile_"+string,generate_tab(arm_quantile))
np.save("../data/uniform_"+string,generate_tab(arm_uniform))