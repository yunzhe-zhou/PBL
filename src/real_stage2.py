...
np.save("../data/action1_"+string,act_tab1)
np.save("../data/non_pessi1_"+string,generate_tab(arm1_non_pessi))
np.save("../data/pessi1_"+string,generate_tab(arm1_pessi))
np.save("../data/uniform1_"+string,generate_tab(arm1_uniform))

np.save("../data/action2_"+string,act_tab2)
np.save("../data/non_pessi2_"+string,generate_tab(arm2_non_pessi))
np.save("../data/pessi2_"+string,generate_tab(arm2_pessi))
np.save("../data/uniform2_"+string,generate_tab(arm2_uniform))